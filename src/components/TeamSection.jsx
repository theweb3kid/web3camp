...
const TeamSection = () => {
  return (
    ...
    <div className=" flex flex-col md:items-start items-center flex-wrap justify-start md:justify-between gap-8 px-28 w-full max-w-[1440px] py-16 mx-auto text-gray-100 font-montserrat">
      ...
      <div className="flex flex-col flex-wrap items-start justify-start gap-8">
        <div className="flex flex-col items-start justify-start gap-4  h-auto">
          <div className="self-stretch relative tracking-[0.03em] font-semibold">
