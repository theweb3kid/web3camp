const SponsorCard = () => {
    return (
      // <div className="flex flex-col items-start flex-wrap justify-start gap-[24px]  py-16  text-13xl text-gray-100 font-montserrat">
      ...
      <div className="flex flex-col flex-wrap items-start justify-start gap-[32px]">
        <div className="flex flex-wrap md:flex-row flex-col items-center justify-start gap-[74px]">
          <img
            className="relative w-44 h-[58px] object-cover"
            alt=""
            src="/image-10@2x.png"
          ...
          />
          <img
            className="relative w-[132px] h-[79.03px] object-cover"
            alt=""
            src="/image-15@2x.png"
          />
          <img
        ...
        <div className="flex flex-wrap flex-row items-center justify-start gap-[99px]">
          <img
            className="relative w-[139px] h-[58px] object-cover"
            alt=""
            src="/image-11@2x.png"
          />
          <img
            className="relative w-[188px] h-[30px] overflow-hidden shrink-0"
            alt=""
            src="/nervos@2x.png"
          />
          <img
